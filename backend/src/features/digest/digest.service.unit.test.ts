...
describe('DigestService - Empty Digest Validation', () => {
  ...
  const testSubscriber: Subscriber = {
    profile: {
      name: 'Test User',
      // phoneNumber: '+1234567890', // removed as it is not in Subscriber type
      learningLanguages: [{
        languageName: 'German',
        overallLevel: 'A2',
        deficiencies: [],
    ...
    metadata: {
      ...
      streakData: {
        ...
        lastIncrement: new Date() // Added required field
      },
      predictedChurnRisk: 0,
      engagementScore: 50,
      difficultyPreference: 'moderate', // Fixed type mismatch
      mistakeTolerance: 'normal' // Added required field
    },
    isPremium: false,
