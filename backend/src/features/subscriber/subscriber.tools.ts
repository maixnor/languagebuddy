          ...
          if (updates.profile.speakingLanguages) {
            ...
            domainUpdates.profile.speakingLanguages =
              updates.profile.speakingLanguages.map((lang) => ({
                ...
                // Removed 'level' and 'currentObjectives' as they are not direct properties of the Language interface.
                // Further refinement may be needed to map these appropriately to 'overallLevel' or other nested fields.
              }));
          }
  ...
  new DynamicStructuredTool({
    ...
    func: async (input) => {
      ...
      try {
            ...
            speakingLanguages: [
              {
                ...
                totalPracticeTime: 0,
                confidenceScore: 100, // Native language assumed high confidence
        ...
        // TODO: onboardingService is not defined. Will need to be handled during onboarding feature migration.
